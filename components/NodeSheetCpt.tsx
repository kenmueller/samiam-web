...
import NodeSheetCptProbabilityOfEvidence from './NodeSheetCptProbabilityOfEvidence'
...
const NodeSheetCpt = ({ node }: { node: Node }) => {
	...
	return (
		<div className="flex flex-col gap-4 max-w-max">
				...
				>
					...
					>
						...
						<tbody>
							...
							<tr>
								{parents.length > 0 && <th colSpan={parents.length} />}
			...
			<NodeSheetCptProbabilityOfEvidence />
		</div>
	)
}
